...
const stories = [
  ...
  },
  {
    id: 7,
    name: "Rajesh Karki",
    role: "Ward Chairperson, Nuwakot",
    category: "Local Government",
    text: "The collaboration between VIN and our local government has been instrumental in improving the basic infrastructure of our ward. From building gender-friendly toilets in schools to installing solar lights in public spaces, VIN's integrated approach to development complements our municipal plans perfectly. We appreciate their transparency and commitment to long-term community growth.",
    image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&q=80",
    signature: "Rajesh Karki",
    signatureTitle: "Local Government Representative",
  },
  {
    id: 8,
    name: "Rotary Club Kathmandu",
    role: "Strategic Partner",
    category: "Partners",
    text: "Partnering with VIN has allowed us to scale our impact in rural Nepal. Their deep-rooted community ties and professional project management ensure that every project we fund is sustainable and reaches the intended beneficiaries. We've worked together on clean water initiatives and literacy programs, and the results have consistently exceeded our expectations.",
    image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&q=80",
    signature: "Partner Organization",
    signatureTitle: "Project Sponsor",
  },
  {
    id: 9,
    ...
    isVideo: true,
    text: "Watch this heart-touching video testimonial from the people of Jitpur Phedi about how VIN's holistic development program transformed their village over the last decade.",
    image: "https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=800&q=80",
    videoUrl: "#",
    signature: "Community Voices",
    signatureTitle: "Video Report",
  }
];
            ...
            {filteredStories.map((story, i) => (
              ...
              >
                ...
                <div className="w-full md:w-[300px] lg:w-[320px] shrink-0">
                  <div className="relative aspect-square overflow-hidden rounded-[5px] shadow-sm group cursor-pointer">
                    <img
                      src={story.image}
                      alt={story.name}
