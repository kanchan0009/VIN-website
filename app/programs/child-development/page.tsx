              ...
              >
                {[1, 2, 3].map((item) => (
                  ...
                  <div className="bg-[#1e238f] p-6 flex-1 flex flex-col">
                    ...
                    <Link href="/programs-projects?topic=child-development" className="mt-auto text-white text-sm font-[600] flex items-center gap-2 hover:translate-x-2 transition-transform">
                      Read More 
                      <ArrowRight size={16} />
                    </Link>
                  </div>
