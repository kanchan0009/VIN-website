          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-2/3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="h-[325px] p-5 md:p-10 rounded-[10px] border border-[#D9D9D9] shadow-sm hover:shadow-md transition-all duration-300 bg-white">
      ...
      <section className="py-10 md:py-20 bg-white">
        <div className="   mx-auto px-6">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="text-xl md:text-3xl lg:text-[50px] font-[700] text-[#1a1a1a] mb-4">
              Google Review Wall of Love
            </h2>
          ...
          {/* Rating Header */}
          <div className="bg-[#F2F2F2] rounded-[15px] p-6 mb-8 md:mb-16 flex flex-col md:flex-row items-center justify-between gap-6 border border-gray-100">
          ...
          <div className="relative group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-[#F2F2F2] rounded-[20px] p-4 md:p-8 flex flex-col items-center text-center shadow-sm border border-gray-50 hover:shadow-md transition-all">
