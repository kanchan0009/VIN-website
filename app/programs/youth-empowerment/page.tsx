...
const whyItems = [
  { title: 'Future Leaders', icon: '🚀', desc: "Youth are the backbone of community development; investing in them is investing in a sustainable future." },
  { title: 'Economic Growth', icon: '📈', desc: "By equipping youth with skills, we reduce unemployment and drive local economic growth and innovation." },
  { title: 'Social Change', icon: '🌍', desc: "Young people are natural catalysts for social change, challenging outdated norms and promoting progress." },
  { title: 'Skill Building', icon: '🛠️', desc: "Focused training in technology, communication, and management prepares youth for the modern global economy." },
];
      ...
      <section className="bg-white pt-10 pb-6">
        <div className=" mx-auto px-6">
          ...
          <div className="">
            ...
            <Link href="/programs/youth-empowerment/overview" className="text-[var(--blue)] text-[16px] font-[600] hover:underline">
              Read More..
            </Link>
          </div>
        </div>
