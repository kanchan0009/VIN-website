    ...
    <main>
      ...
      <section className="relative h-80 flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pb-10 w-full">
          ...
          <h1 className="text-5xl font-bold text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>All Programs</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Our Community Development Programs</h2>
              ...
              <div key={p.title} className="rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3">
                    <span className="text-xl font-bold text-white" style={{ fontFamily: 'Playfair Display, serif' }}>{p.stat}</span>
                    <span className="text-white/80 text-xs block">{p.statLabel}</span>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-lg font-bold mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>{p.title}</h3>
      ...
      <section className="py-20" style={{ background: 'var(--sky)' }}>
        <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-12 items-start">
          <div className="flex-1">
            <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Donate us to help empower the most marginalized rural communities in Nepal!</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[{ icon: '💰', label: 'Fund Raised & Donation Treat raised' }, { icon: '🤝', label: 'We Helping People & Donation pik' }].map(item => (
                <div key={item.icon} className="flex items-center gap-3 p-4 bg-white rounded-xl">
