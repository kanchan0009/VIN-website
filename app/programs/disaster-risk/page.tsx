...
const whyItems = [
  { title: 'Vulnerable Landscape', icon: '⛰️', desc: "Nepal's geography makes it highly susceptible to earthquakes, landslides, and floods; preparedness is a necessity." },
  { title: 'Resilient Communities', icon: '🏘️', desc: "Building local capacity to respond to disasters ensures faster recovery and reduces loss of life and property." },
  { title: 'Proactive Mitigation', icon: '🛡️', desc: "Investing in disaster risk reduction is more cost-effective and humane than responding only after a catastrophe occurs." },
  { title: 'Safe Infrastructure', icon: '🏗️', desc: "Ensuring that the places where people live and learn can withstand the forces of nature." },
];
      ...
      <section className="bg-white pt-10 pb-6">
        <div className=" mx-auto px-6">
          ...
          <div className="">
            ...
            <Link href="/programs/disaster-risk/overview" className="text-[var(--blue)] text-[16px] font-[600] hover:underline">
              Read More..
            </Link>
          </div>
        </div>
