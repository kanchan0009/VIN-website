...
import { ArrowRight, CheckCircle, Play, ChevronLeft, ChevronRight, ChevronDown, Leaf, ThermometerSun, Droplets, GraduationCap } from 'lucide-react';
...
const whyItems = [
  { title: 'Ecological Balance', icon: <Leaf size={32} className="text-[var(--blue)]" />, desc: "Preserving Nepal's unique biodiversity is essential for the health of both the environment and the people." },
  { title: 'Climate Action', icon: <ThermometerSun size={32} className="text-[var(--blue)]" />, desc: "Taking local steps to address the global climate crisis through reforestation and sustainable living." },
  { title: 'Sustainable Resources', icon: <Droplets size={32} className="text-[var(--blue)]" />, desc: "Ensuring that future generations have access to clean water, fertile soil, and healthy forests." },
  { title: 'Eco-Education', icon: <GraduationCap size={32} className="text-[var(--blue)]" />, desc: "Building a culture of environmental stewardship among the youth and community leaders." },
];
...
const albums = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1618477461853-cf6ed80fbfc9?w=800&q=80",
  },
  {
          ...
          <div className="">
            <p className="text-gray-600 text-[14px] lg:text-[16px] leading-relaxed font-[400] mb-2">
              ...
              {isExpanded && (
                <>
                  <br /><br />
                  Our initiatives include large-scale reforestation drives, the establishment of community-led waste management systems, and training in climate-resilient organic farming. We believe that environmental protection is intrinsically linked to community wellbeing.
                  <br /><br />
                  By educating the younger generation and empowering local leaders with sustainable tools, we are creating a model of conservation that is both ecologically sound and economically viable for rural Nepal.
                </>
              )}
            </p>
            <button 
              ...
              >
                {albums.map((album, idx) => (
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end pb-5 md:pb-10 text-center px-6">
                    ...
                    <Link href="/program-gallery?topic=environment">
              ...
              >
                {[1, 2, 3].map((item) => (
                  ...
                  <div className="bg-[#1e238f] p-6 flex-1 flex flex-col">
                    ...
                    <Link href="/programs-projects?topic=environment" className="mt-auto text-white text-sm font-[600] flex items-center gap-2 hover:translate-x-2 transition-transform">
                      Read More 
                      <ArrowRight size={16} />
                    </Link>
                  </div>
