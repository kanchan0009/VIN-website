...
const whyItems = [
  { title: 'Lifesaving Care', icon: '🩺', desc: "Providing immediate medical attention to those who would otherwise have no access to healthcare professionals." },
  { title: 'Disease Prevention', icon: '🧼', desc: "Focusing on hygiene and sanitation to tackle the root causes of common illnesses in rural Nepal." },
  { title: 'Community Wellness', icon: '❤️', desc: "Building a healthier community through consistent support, education, and health monitoring." },
  { title: 'Sustainable Infrastructure', icon: '🏗️', desc: "Building toilets and clean water systems that provide lasting health benefits to entire villages." },
];
      ...
      <section className="bg-white pt-10 pb-6">
        <div className=" mx-auto px-6">
          ...
          <div className="">
            ...
            <Link href="/programs/public-health/overview" className="text-[var(--blue)] text-[16px] font-[600] hover:underline">
              Read More..
            </Link>
          </div>
        </div>
